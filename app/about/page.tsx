...
export default function About() {
  return (
    <div className="flex flex-col lg:flex-row">
      <div className="w-full overflow-y-auto p-4 lg:p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8">
            ...
            <TypographyP>{`I'm naturally attracted to arts, such as music, theatre, and dance, in different forms and shapes. I'm drawn to humanities, anthropology, tribalism, naturalism, society, philosophy, and more. I'm a big fan of the body and mind, and I practice meditation.
      ...
      {/* Right column */}
      <div className="w-full lg:w-1/3 lg:fixed lg:right-0 lg:h-screen p-4 lg:p-8 overflow-y-auto">
